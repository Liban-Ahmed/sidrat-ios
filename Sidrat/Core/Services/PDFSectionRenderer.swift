//
//  PDFSectionRenderer.swift
//  Sidrat
//
//  PDF Section Rendering Helper for PDFExportService
//  Extracts drawing logic to maintain line limits and separation of concerns
//

import Foundation
import UIKit

/// Helper class for rendering individual sections of the PDF report
/// Static methods allow reusable rendering logic without maintaining state
struct PDFSectionRenderer {
    ...
    static func drawHeader(report: ProgressReport, at startY: CGFloat, context: UIGraphicsPDFRendererContext) -> CGFloat {
        var currentY = startY
    ...
    static func drawStatsOverview(report: ProgressReport, at startY: CGFloat, context: UIGraphicsPDFRendererContext) -> CGFloat {
        var currentY = startY
        let marginLeft = PDFConstants.marginLeft
    ...
    private static func drawStatBox(title: String, value: String, icon: String, at origin: CGPoint, size: CGSize) {
        // Background
    ...
    static func drawWeekComparison(report: ProgressReport, at startY: CGFloat, context: UIGraphicsPDFRendererContext) -> CGFloat {
        var currentY = startY
        let marginLeft = PDFConstants.marginLeft
    ...
    private static func drawComparisonBox(title: String, value: String, subtitle: String, highlight: Bool, at origin: CGPoint, size: CGSize) {
        // Background
        let boxRect = CGRect(origin: origin, size: size)
    ...
    static func drawCategoryProgress(report: ProgressReport, at startY: CGFloat, context: UIGraphicsPDFRendererContext) -> CGFloat {
        var currentY = startY
        let marginLeft = PDFConstants.marginLeft
    ...
    private static func drawCategoryProgressRow(stats: CategoryStats, at y: CGFloat) -> CGFloat {
        let marginLeft = PDFConstants.marginLeft
    ...
    static func drawAchievements(report: ProgressReport, at startY: CGFloat, context: UIGraphicsPDFRendererContext) -> CGFloat {
        var currentY = startY
        let marginLeft = PDFConstants.marginLeft
    ...
    private static func drawAchievementBadge(achievementType: AchievementType, at origin: CGPoint, size: CGSize) {
        // Background
        let boxRect = CGRect(origin: origin, size: size)
        let boxPath = UIBezierPath(roundedRect: boxRect, cornerRadius: 8)
    ...
    static func drawFooter(report: ProgressReport, context: UIGraphicsPDFRendererContext) {
        let marginLeft = PDFConstants.marginLeft
    ...
    static func drawSectionTitle(_ title: String, at y: CGFloat) -> CGFloat {
        let titleAttributes: [NSAttributedString.Key: Any] = [
